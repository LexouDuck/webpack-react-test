...
<head>
```
Where all page metadata (~HTML preprocessor info) elements are kept, this includes <style>, <script>, <title>, tags/keywords for bots, character encoding (<meta charset="">), icon (see favicon.ico), browser compatibility information (<meta http-equiv="" content="">). See more at https://www.w3schools.com/html/html_head.asp
